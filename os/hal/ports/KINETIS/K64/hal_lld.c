...
/**
 * @brief   K64 clock initialization.
...
void k64_clock_init(void) {
   ...
   */
  /*
   * PLL_PRDIV and PLL_VDIV come from pllconfig.h
   * which is generated at compile time by the utility
   * findpll.
   */
  MCG->C5 = MCG_C5_PRDIV0(PLL_PRDIV);
  MCG->C6 = MCG_C6_PLLS | MCG_C6_VDIV0(PLL_VDIV);
