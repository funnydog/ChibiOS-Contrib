...
#if !defined(K64) || defined(__DOXYGEN__)
#define K64
#endif
 ...
 */
#define KINETIS_SYSCLK_MAX      120000000UL

/**
 * @brief   Maximum bus clock (f_BUS) frequency.
 */
#define KINETIS_BUSCLK_MAX      60000000UL

/**
 * @brief   Maximum flash clock (f_FLASH) frequency.
 */
#define KINETIS_FLASHCLK_MAX    24000000UL

/**
 * @brief   Maximum FlexBus clock (f_TODO) frequency.
 */
#define KINETIS_FLEXBUSCLK_MAX  40000000UL

/* MPU attributes. */
#define KINETIS_HAS_MPU             TRUE
...
#define KINTEIS_DAC1_IRQ_VECTOR     Vector160
...
#define KINETIS_DMA5_IRQ_VECTOR     Vector53
