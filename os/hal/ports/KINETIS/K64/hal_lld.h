...
/**
 * @file    K64/hal_lld.h
 * @brief   Kinetis K64 HAL subsystem low level driver header.
 *
 * @addtogroup HAL
 * @{
 */
 ...
 * @note    The allowed range is 1..16
 * @note    The default value is calculated for a 60 MHz bus clock
 *          from a 120 MHz PLL output.
 */
#if !defined(KINETIS_CLKDIV1_OUTDIV2) || defined(__DOXYGEN__)
  #if defined(KINETIS_BUSCLK_FREQUENCY) && KINETIS_BUSCLK_FREQUENCY > 0UL
 ...
 */
  ...
  #else
    #define KINETIS_CLKDIV1_OUTDIV4     5
  #endif
#endif
...
#if KINETIS_SYSCLK_FREQUENCY < 48000000UL || KINETIS_SYSCLK_FREQUENCY > KINETIS_SYSCLK_MAX
